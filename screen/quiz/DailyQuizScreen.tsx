      ...
      {showResultComponent ?
        ...
        :
          <View style={tailwind`flex-1`}>
            ...
            {!startQuiz ?
              <View style={tailwind`flex-1 justify-center mt-[-100px]`}>
                <Text style={[tailwind`pt-4 px-3 text-[16px] text-center`, { color: textColor }]}>You have 2 mins to answer five Questions, and your time start immediately you click on the start quiz button. please read the question and your selected answer carefully. Once you click Next button, you will not be able to return to the previous question. and make sure you click on the next button after answering the question before the time runs out</Text>
