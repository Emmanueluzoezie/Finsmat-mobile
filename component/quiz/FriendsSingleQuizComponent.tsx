...
const FriendsSingleQuizComponent: React.FC<SingleQuizComponentProps> = ({
    answerOne,
    answerTwo,
    question,
    id,
            ...
            <View style={[tailwind`w-full px-4`]}>
                ...
                <View style={[tailwind`mt-4`]}>
                    ...
                    >
                        ...
                        <Text style={[
                            tailwind`text-center pl-4 text-[15px]`, { fontFamily: 'Lato-Bold' },
                            selectedAnswer === answerTwo ?
                                { color: bgColor, fontWeight: "700" }
                                :
                                { color },
...
export default FriendsSingleQuizComponent;